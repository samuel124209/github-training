...
2. Create a branch named `add-your-name`
3. Create a file in the `students/` folder named `firstname-lastname.md`
4. Add your information to the file
5. Update `intro.txt` by adding one line with your name
